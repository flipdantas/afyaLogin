...
const FormSignIn: React.FC = () => {
  ...
  const loginSubmit = useCallback(
    ...
    ).catch( err => toast.error('Poxa, algo deu errado T.T')).finally(() => setIsLoad(false)
    )
    ...
    <FormSignInContent>
      { isLoad ? ( <p>Carregando</p> ) : (
        <form onSubmit={loginSubmit}>
          <input type="text" placeholder="Nome de usuário" onChange={ e => setFormDataContent({...formDataContent, usuario: e.target.value})}/>
